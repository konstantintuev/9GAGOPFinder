...
import tuev.konstantin.a9gagopfinder.internal.Remounter;
import tuev.konstantin.a9gagopfinder.internal.RootToolsInternalMethods;
import tuev.konstantin.a9gagopfinder.internal.Runner;
...
public final class RootTools {
    ...
    public static void log(String TAG, String msg, int type, Exception e) {
        if (msg != null && !msg.equals("")) {
            if (debugMode) {
                if (TAG == null) {
                    TAG = tuev.konstantin.a9gagopfinder.Constants.TAG;
                }
