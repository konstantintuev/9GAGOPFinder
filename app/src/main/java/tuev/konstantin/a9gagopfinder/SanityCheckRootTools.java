...
public class SanityCheckRootTools extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tuev.konstantin.a9gagopfinder.RootTools.debugMode = true;
        ...
        if (tuev.konstantin.a9gagopfinder.RootTools.isRootAvailable()) {
            print("Root found.\n");
        } else {
        ...
        try {
            if (!tuev.konstantin.a9gagopfinder.RootTools.isAccessGiven()) {
    ...
    private class SanityCheckThread extends Thread {
        ...
        public void run() {
            ...
            */
            ...
            try {
                List<String> paths = tuev.konstantin.a9gagopfinder.RootTools.getPath();
            ...
            for (int i = 0; i < 100; i++) {
                tuev.konstantin.a9gagopfinder.RootTools.exists("/system/xbin/busybox");
            }

            visualUpdate(TestHandler.ACTION_PDISPLAY, "Testing Find Binary");
            result = tuev.konstantin.a9gagopfinder.RootTools.isRootAvailable();
            ...
            visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.exists("/system/sbin/[") + " k\n\n");

            visualUpdate(TestHandler.ACTION_PDISPLAY, "Testing Is Access Given");
            result = tuev.konstantin.a9gagopfinder.RootTools.isAccessGiven();
            ...
            result = tuev.konstantin.a9gagopfinder.RootTools.remount("/system", "rw");
            ...
            visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.checkUtil("busybox") + " k\n\n");
            ...
            visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.getBusyBoxVersion("/system/xbin/") + " k\n\n");

            try {
                visualUpdate(TestHandler.ACTION_PDISPLAY, "Testing fixUtils");
                visualUpdate(TestHandler.ACTION_DISPLAY, "[ Checking Utils ]\n");
                visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.fixUtils(new String[]{"ls", "rm", "ln", "dd", "chmod", "mount"}) + " k\n\n");
            } catch (Exception e2) {
                // TODO Auto-generated catch block
                e2.printStackTrace();
            }
            ...
            try {
                ...
                visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.getSymlink("/system/bin/[[") + " k\n\n");
            } catch (Exception e2) {
                // TODO Auto-generated catch block
                e2.printStackTrace();
            }
            ...
            visualUpdate(TestHandler.ACTION_DISPLAY, tuev.konstantin.a9gagopfinder.RootTools.getInode("/system/bin/busybox") + " k\n\n");
            ...
            try {
                ...
                for (String applet : tuev.konstantin.a9gagopfinder.RootTools.getBusyBoxApplets("/data/data/stericson.busybox/files/bb/busybox")) {
            ...
            try {
                ...
                String v = tuev.konstantin.a9gagopfinder.RootTools.getBusyBoxVersion("/data/data/stericson.busybox/files/bb/");
            ...
            Permissions permissions = tuev.konstantin.a9gagopfinder.RootTools.getFilePermissionsSymlinks("/system/xbin/busybox");
            ...
            try {
                shell = tuev.konstantin.a9gagopfinder.RootTools.getShell(true);
            ...
            try {
                shell = tuev.konstantin.a9gagopfinder.RootTools.getShell(true, Shell.ShellContext.SYSTEM_APP);
                Command cmd = new Command(
                        0,
                        "id") {
            ...
            try {
                shell = tuev.konstantin.a9gagopfinder.RootTools.getShell(true, Shell.ShellContext.UNTRUSTED_APP);
                Command cmd = new Command(
                        0,
                        "id") {
            ...
            long spaceValue = tuev.konstantin.a9gagopfinder.RootTools.getSpace("/data");
            ...
            try {
                ...
                Command cmd = new Command(42, false, "echo done") {
                    ...
                    public void commandOutput(int id, String line) {
                        if (_catch) {
                            tuev.konstantin.a9gagopfinder.RootTools.log("CAUGHT!!!");
                        }
                    ...
                    public void commandTerminated(int id, String reason) {
                        synchronized (SanityCheckRootTools.this) {
                            ...
                            try {
                                tuev.konstantin.a9gagopfinder.RootTools.closeAllShells();
                            } catch (IOException e) {
                                // TODO Auto-generated catch block
                                e.printStackTrace();
                            }
